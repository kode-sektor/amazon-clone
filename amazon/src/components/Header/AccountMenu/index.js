        ...
        <div className="navigationbar__account nav__flyout">
            ...
            <div className="navigationbar__account__flyout__content">
                <div className="navigationbar__buy__again">
                    <h3 className="a-spacing-base">Buy it again</h3>
                    <div className="a-section a-spacing-micro logged-list static-list">
                        <div className="a-section p13n-sc-list-cells-container">
                            <ul className="a-unordered-list a-nostyle a-vertical p13n-sc-list-cells">
                                <li data-fling-container="true" className="a-spacing-medium p13n-sc-list-item">
                                    <span className="a-list-item">
                                        <div className="a-fixed-left-grid">
                                            <div className="a-fixed-left-grid-inner" style={{paddingLeft: "87px"}}>
                                                <div className="a-fixed-left-grid-col" style={{width: "87px", marginLeft: "-87px", float: "left"}}>
                                                    <a className="a-link-normal" href="#">
                                                        <img alt="" src="" className="a-dynamic-image" height="75" width="75"/>
                                                    </a>
                                                </div>
                                                <div className="a-fixed-left-grid-col a-col-right" style={{paddingLeft: "0", float: "left"}}>
                                                    <a className="a-link-normal" href="#">
                                                        <div className="p13n-sc-truncate-desktop-type2 p13n-sc-truncated" aria-hidden="true" data-rows="3" title="Listerine Cool Mint Antiseptic Mouthwash for Gingivitis and Bad Breath, 1.5L">Listerine Cool Mint Antiseptic Mouthwash for Gingivitis and Bad…</div>
                                                    </a>
                                                    <div className="a-icon-row a-spacing-none">
                                                        <a className="a-link-normal" title="4.8 out of 5 stars" href="/product-reviews/B00PQKRJY4/ref=pd_nav_hcs">
                                                            <i className="a-icon a-icon-star a-star-5">
                                                                <span className="a-icon-alt">4.8 out of 5 stars</span>
                                                            </i>
                                                        </a>
                                                        <a className="a-size-small a-link-normal" href="/product-reviews/B00PQKRJY4">811</a>
                                                    </div>
                                                    <div className="a-row">
                                ...
                                <li data-fling-container="true" className="a-spacing-medium p13n-sc-list-item">
                                    <span className="a-list-item">
                                        <div className="a-fixed-left-grid">
                                            <div className="a-fixed-left-grid-inner" style={{paddinLeft: "87px"}}>
                                                <div className="a-fixed-left-grid-col a-col-left" style={{width: "87px", marginLeft: "-87px", float: "left"}}>
                                                    <a className="a-link-normal" href="">
                                                        <img alt="" src="" className="a-dynamic-image p13n-sc-dynamic-image" height="64" width="75" />
                                                    </a>
                                                </div>
                                                <div className="a-fixed-left-grid-col a-col-right" style={{paddingLeft: "0%", float: "left"}}>
                                                    <a className="a-link-normal" href="#">
                                                        <div className="p13n-sc-truncated" aria-hidden="true" title="">Hilroy Coil 1-subject Wide Ruled Notebook, 10.5 X 8 Inches, 3 Hole…</div>
                                                    </a>
                                                    <div className="a-icon-row a-spacing-none">
                                                        <a className="a-link-normal" title="4.7 out of 5 stars" href="/product-reviews/B003M5PCVC/ref=pd_nav_hcs">
                                                            <i className="a-icon a-icon-star a-star-4-5 aok-align-top">
                                                                <span className="a-icon-alt">4.7 out of 5 stars</span>
                                                            </i>
                                                        </a>
                                                        <a className="a-size-small a-link-normal" href="/product-reviews/B003M5PCVC/ref=pd_nav_hcs">1,747</a>
                                                    </div>
                                                    <div className="a-row">
                                                        <a className="a-link-normal a-text-normal" href="#">
                                                            <span className="a-size-base a-color-price">
                                                                <span className="p13n-sc-price">CDN$2.27</span>
                                                            </span>
                                                        </a>   
                                                    </div>
                                                    <div className="a-section a-spacing-top-micro">
                                                        <form method="post" action="/gp/item-dispatch/ref=pd_nav_hcs" className="a-spacing-none">
                                                            ...
                                                            <span className="a-button a-spacing-top-none a-button-primary a-button-small">
                                                                <span className="a-button-inner">
                                                                    <input name="submit.addToCart" className="a-button-input" type="submit" value="Buy it again (2)" />
                                                                    <span className="a-button-text" aria-hidden="true">Buy it again (2)
                                                                    </span>
                                                                </span>
                                                            </span>
                                                        </form>
