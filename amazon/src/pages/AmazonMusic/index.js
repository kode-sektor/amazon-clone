        ...
        <>
            <section className="amazonMusic--page">
                ...
                <main className="amazonMusic--main">
                    ...
                    />
                    <CarouselMusic
                        heading={"Top Political Podcasts"}
                        slider={
                                [
                                    <Slider 
                                        type={"music"}
                    ...
                    />
                    <CarouselMusic
                        heading={"Top Society & Culture Podcasts"}
                        slider={
                                [
                                    <Slider 
                                        type={"music"}
                    ...
                    />
                    <CarouselMusic
                        heading={"Top Kids & Family Podcasts"}
                        slider={
                                [
                                    <Slider 
                                        type={"music"}
            ...
            <footer className="amazonMusic__footer">
                <div className="amazonMusic__footerDiv"></div>
                <section className="amazonMusic__footerContainer">
                    <section className="amazonMusic__footerMeta">
                        <ul className="m-0 w-100">
                            <li>
                                <figure>
                                    <Link to="/">
                                        <img class="music__nonagonImg" src={sweet_home_alabama} alt="Sweet Home Alabama" />
                                    </Link>
                                    <figcaption>
                                        <em>Wednesday, November 10, 2021</em>
                                        <span>Up First</span>
                                    </figcaption>
                                    <button class="music__carouselBtn">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                ...
                                <div class="amazonMusic__footerExpand">
                                    <button>
                                        <AiOutlineExpandAlt />
                                    </button>
                                </div>
                    ...
                    <section className="amazonMusic__player">
                        Ya
                    </section>
                </section>
            </footer>
